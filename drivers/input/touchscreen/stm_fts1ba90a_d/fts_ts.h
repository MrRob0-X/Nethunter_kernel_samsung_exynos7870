...
#define FIRMWARE_IC			"d_fts_ic"
#define FTS_MAX_FW_PATH			64
#define FTS_TS_DRV_NAME			"d_fts_touch"
...
void d_fts_fw_init(struct fts_ts_info *info, bool boot);
...
int d_fts_irq_enable(struct fts_ts_info *info, bool enable);
int d_fts_set_calibration_information(struct fts_ts_info *info, u8 count, u16 version);
int d_fts_get_tsp_test_result(struct fts_ts_info *info);
int d_fts_read_pressure_data(struct fts_ts_info *info);
...
int d_fts_set_pressure_calibration_information(struct fts_ts_info *info, u8 base, u8 delta);
int d_fts_get_pressure_calibration_information(struct fts_ts_info *info);
...
extern void d_fts_set_grip_data_to_ic(struct fts_ts_info *info, u8 flag);
extern void d_fts_set_grip_type(struct fts_ts_info *info, u8 set_type);
